...
class UserProfile(models.Model):
    ...
    achievements = models.ManyToManyField(
        "Achievement", through="UserAchievement", related_name="usuarios", blank=True
    )
...
class UserAchievement(models.Model):
    ...
    conquistada_em = models.DateTimeField(
...
class UserLesson(models.Model):
    ...
    usuario = models.ForeignKey(
        UserProfile, on_delete=models.CASCADE, related_name="progresso_licoes"
    )
    licao = models.ForeignKey(
        "trilha.Licao", on_delete=models.CASCADE, related_name="progressos_usuarios"
    )
    ...
    concluida_em = models.DateTimeField(
        null=True, blank=True, db_index=True, verbose_name="Concluída em"
    )
...
class VocabularyProgress(models.Model):
    ...
    usuario = models.ForeignKey(
        UserProfile, on_delete=models.CASCADE, related_name="progresso_vocabulario"
    )
...
class FilaExercicioUsuario(models.Model):
    ...
    usuario = models.ForeignKey(
        "UserProfile", on_delete=models.CASCADE, related_name="fila_exercicios"
    )
...
class DailyStudyLog(models.Model):
    ...
    exercicios_respondidos = models.IntegerField(
        default=0, verbose_name="Exercícios Respondidos"
    )
    exercicios_corretos = models.IntegerField(
        default=0, verbose_name="Exercícios Corretos"
    )
    tempo_estudo_segundos = models.IntegerField(
