...
class _PublishPipelineDialogState extends State<PublishPipelineDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final quests = (widget.worldBundle['quests'] as List?)?.length ?? 0;
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Gera snapshot imutável para consumo no mobile',
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: [
                    ...
                    const SizedBox(width: 8),
                    _buildEntityBadge('Quests', '$quests', const Color(0xFFFBBF24)),
                  ],
                ),
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    label: Text(_isSubmitting ? 'Publicando...' : 'Publicar Versão'),
